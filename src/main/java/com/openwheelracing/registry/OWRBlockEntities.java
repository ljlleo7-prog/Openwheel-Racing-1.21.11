...
public final class OWRBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<CarAssemblyWorkstationBlockEntity>> CAR_CONSTRUCTION_STATION = BLOCK_ENTITIES.register("car_construction_station",
    ...
    public static final RegistryObject<BlockEntityType<CarAssemblyWorkstationBlockEntity>> CAR_SETUP_STATION = BLOCK_ENTITIES.register("car_setup_station",
    ...
    public static final RegistryObject<BlockEntityType<CarAssemblyWorkstationBlockEntity>> CAR_LIVERY_STATION = BLOCK_ENTITIES.register("car_livery_station",
    ...
    public static final RegistryObject<BlockEntityType<CarPartsReplacementWorkstationBlockEntity>> CAR_PARTS_REPLACEMENT_STATION = BLOCK_ENTITIES.register("car_parts_replacement_station",
    ...
    public static final RegistryObject<BlockEntityType<RaceDirectorBlockEntity>> RACE_BOARD_TERMINAL = BLOCK_ENTITIES.register("race_board_terminal",
    ...
    public static final RegistryObject<BlockEntityType<RaceDirectorBlockEntity>> TEAM_TERMINAL = BLOCK_ENTITIES.register("team_terminal",
    ...
    public static final RegistryObject<BlockEntityType<RaceLightBlockEntity>> FLAG_LIGHT = BLOCK_ENTITIES.register("flag_light",
        () -> new BlockEntityType<>((pos, state) -> new RaceLightBlockEntity(pos, state, RaceLightType.FLAG), Set.of(OWRBlocks.FLAG_LIGHT.get())));
    public static final RegistryObject<BlockEntityType<RaceLightBlockEntity>> STARTING_LIGHT = BLOCK_ENTITIES.register("starting_light",
        () -> new BlockEntityType<>((pos, state) -> new RaceLightBlockEntity(pos, state, RaceLightType.START), Set.of(OWRBlocks.STARTING_LIGHT.get())));
    public static final RegistryObject<BlockEntityType<RaceLightBlockEntity>> PIT_LIGHT = BLOCK_ENTITIES.register("pit_light",
    ...
    public static RegistryObject<BlockEntityType<CarAssemblyWorkstationBlockEntity>> typeFor(CarWorkstationType workstationType) {
    ...
    public static RegistryObject<BlockEntityType<RaceDirectorBlockEntity>> typeFor(RaceMonitorType monitorType) {
    ...
    public static RegistryObject<BlockEntityType<RaceLightBlockEntity>> typeFor(RaceLightType type) {
