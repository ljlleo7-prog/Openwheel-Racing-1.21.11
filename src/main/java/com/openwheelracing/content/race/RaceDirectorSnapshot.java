...
public record RaceDirectorSnapshot(boolean checkpointCheckEnabled, boolean offTrackCheckEnabled, int minimumValidLapTicks, int raceLapLimit, int page, int maxPage, int raceControlRevision, int lapRecordsRevision,
